...
const SideBarCarDetails = () => {
  return (
    <div className="flex justify-center gap-7  lg:hidden mt-5 max-md:flex-col">
      <div className="bg-surface_primary shadow-lg rounded-xl h-[230px] p-5 flex flex-col justify-center gap-3 md:w-1/2 w-full">
        <div className="flex gap-1 items-center">
          <h2 className="text-2.5xl leading-9 font-bold text-text-heading">
            $17,000
          </h2>
          <small className="text-text-body">Your price w/o taxes & fees</small>
        </div>
      ...
      <div className="bg-surface_primary shadow-lg rounded-xl md:w-1/2 w-full h-[230px] p-5 flex flex-col justify-center gap-3">
        <Link
          href="/"
...
export default SideBarCarDetails;
