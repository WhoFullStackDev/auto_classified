...
const FilterPill: React.FC<FilterPillProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "absolute top-[100%] left-0 bg-surface_primary shadow-lg hidden  z-[8] group-hover:flex group-focus:flex border-border-primary border-2 p-6  justify-center rounded-[20px] flex-col items-center gap-4",
          className
        )}
      >
        {children}
