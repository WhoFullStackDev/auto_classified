  ...
  return (
    <div className="flex justify-center items-center gap-12 mt-7">
      ...
      <div className="flex items-center gap-4">
        <button
          className="flex justify-center items-center w-12 h-12 rounded-full bg-surface_primary shadow-soft-lg cursor-pointer transition-colors duration-300 hover:bg-text-hover focus:bg-button-hover focus:ring focus:ring-text-hover focus:ring-opacity-50 hover:text-white focus:text-white"
