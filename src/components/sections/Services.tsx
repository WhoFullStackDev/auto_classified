  ...
  return (
    <Container>
      <div className="h-full flex justify-center items-center flex-col gap-5">
        <h1 className="font-bold text-[40px] leading-[52px] text-text-heading mt-[120px]">
          Top-Selling Cars
        </h1>
        <div className="w-[1240px] h-[328px] rounded-xl border-2 border-white bg-[linear-gradient(96deg, rgba(255, 255, 255, 0.50) 0%, rgba(255, 255, 255, 0.20) 100%)] mt-10 flex justify-center items-center gap-[120px]">
